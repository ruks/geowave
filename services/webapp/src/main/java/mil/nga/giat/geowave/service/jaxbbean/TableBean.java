...
public class TableBean {
	...
	public void setMajorunningScans(Compacting majorunningScans) {
		this.majorunningScans = majorunningScans;
	}
	public Compacting getMinorCompactions() {
		return minorCompactions;
	}
	public void setMinorCompactions(Compacting minorCompactions) {
		this.minorCompactions = minorCompactions;
	}
	public Compacting getMajorCompactions() {
		return majorCompactions;
	}
	public void setMajorCompactions(Compacting majorCompactions) {
		this.majorCompactions = majorCompactions;
	}
	public TableBean(String tableName, String state, int tablets,
			int offlineTablets, long entries, long entriesInMemory,
			double ingest, double entriesRead, double entriesReturned,
			long holdTime, Compacting majorunningScans,
			Compacting minorCompactions, Compacting majorCompactions) {
		super();
		this.tableName = tableName;
		this.state = state;
		this.tablets = tablets;
